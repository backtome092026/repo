...
function secret(){const value=process.env.OTP_SIGNING_SECRET||(process.env.NODE_ENV!=="production"?process.env.RESEND_API_KEY:undefined);if(!value)throw new Error("OTP_SIGNING_SECRET is not configured");return value}
